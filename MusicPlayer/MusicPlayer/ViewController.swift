...
//        self.addViewsWithCode()
    ...
    func audioPlayerDecodeErrorDidOccur(_ player: AVAudioPlayer, error: Error?) {
        ...
        let alert: UIAlertController = UIAlertController(title: "알림", message: message, preferredStyle: UIAlertController.StyleUIAlertController.StyleUIAlertController.Style.alert)
        
        let okAction: UIAlertAction = UIAlertAction(title: "확인", style: UIAlertAction.StyleUIAlertAction.Style.default) { (action: UIAlertAction) -> Void in
